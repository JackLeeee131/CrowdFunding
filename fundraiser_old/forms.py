...
class CampaignFundRaiserForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'cause':forms.Select(attrs={"class":"select2"}),
            'sensitivity':forms.Select(attrs={"class":"select2"}),
        }
...
class SupportGroupMembersForms(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            "is_show_name":forms.CheckboxInput(attrs={"class":"jss885", "id":"hide_my_name"}),
        }
...
class WithdrawalRequestForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'document' :forms.FileInput(attrs={"onchange":"Validatedocupload(this);", "id":"id_doc", "class":"inputfile inputfile-1", "required":"required"}),
    ...
    def clean(self):
        ...
        if instance_campaign.available_withdrawl_fund() < p_amount:
            self.add_error('amount', 'You dose not have enough money to withdraw.')
