...
$("#manage_user_edit_btn").click(function(){
    ...
    if($("#mobile-number").val().length < 7 ){
         ...
         if(id_name == 1 || id_email == 1 || mobile_number_2 == 1 ){
            return false
        }
...
$("#select_sensitivity").change(function(){
    ...
    if(select_category == 1 || select_cause == 1 || id_picture_two == 1 || select_sensitivity == 1 || id_commission == 1 || id_title == 1 || id_day == 1 || id_goal == 1 || id_short_description == 1 || about_text == 1 ) {
        return false
    }
});
...
$("#manage_support_edit").click(function(){
    ...
    if( select_cause == 1 || id_picture_two == 1 || select_sensitivity == 1 ||  id_title == 1 ||  id_goal == 1 || id_short_description == 1 || about_text == 1 ) {
        return false
    }
});
...
$("#manage_event_edit").click(function(){
    ...
    if( select_cause == 1 || id_picture_two == 1 || select_sensitivity == 1 ||  id_place == 1 ||  id_name == 1 || datetimepicker1 == 1 || about_text == 1 ) {
        return false
    }
});