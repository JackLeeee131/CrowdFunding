...
urlpatterns = [
    ...
    re_path('admin/dashboard/mobilisation-campaign/(?P<ID>[0-9]+)/user/', views.admin_support_group_user, name='admin_support_group_user'),
    ...
    re_path('admin/manage/mobilisation-campaign/(?P<ID>[0-9]+)/edit/', views.admin_manage_support_group_edit, name='admin_manage_support_group_edit'),
    re_path('admin/manage/(?P<ID>[0-9]+)/mobilisation-campaign/(?P<status>[a-z,A-Z]+)/', views.admin_manage_support_group_status, name='admin_manage_support_group_status'),
    path('admin/manage/mobilisation-campaign/', views.admin_manage_support_group, name='admin_manage_support_group'),
    ...
    path('start-mobilisation-campaign/', views.start_support_group, name='start_support_group'),
    ...
    re_path('my-mobilisation-campaign/(?P<ID>[0-9]+)/buzz/', views.my_support_group_buzz, name='my_support_group_buzz'),
    re_path('my-mobilisation-campaign/(?P<ID>[0-9]+)/updates/', views.my_support_group_updates, name='my_support_group_updates'),
    re_path('my-mobilisation-campaign/(?P<ID>[0-9]+)/edit/', views.my_support_group_edit, name='my_support_group_edit'),
    re_path('my-mobilisation-campaign/(?P<ID>[0-9]+)/user/', views.my_support_group_user, name='my_support_group_user'),
    path('my-mobilisation-campaign/', views.my_support_group, name='my_support_group'),
    ...
    re_path('report/mobilisation-campaign/(?P<ID>[0-9]+)/', views.report_support_group_selected, name='report_support_group_selected'),
    re_path('ask-update/mobilisation-campaign/(?P<ID>[0-9]+)/', views.ask_update_support_group_selected, name='ask_update_support_group_selected'),
    re_path('mobilisation-campaign/(?P<ID>[0-9]+)/(?P<name>.*)/', views.support_group_selected, name='support_group_selected'),
